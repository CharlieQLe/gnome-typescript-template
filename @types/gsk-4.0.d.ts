...
enum PathDirection {
    /**
     * The side that leads to the start of the path
     */
    START,
    /**
     * The side that leads to the end of the path
     */
    END,
}
/**
 ...
 */
function path_parse(string: string | null): Path | null
 ...
 * @returns %TRUE to continue evaluating the path, %FALSE to   immediately abort and not call the function again.
 */
interface PathForeachFunc {
    (op: PathOperation, pts: Graphene.Point, n_pts: number): boolean
}
interface BlendNode {
...
interface Path {
     ...
     */
    get_closest_point(point: Graphene.Point, threshold: number): [ /* returnType */ boolean, /* result */ PathPoint ]
    /**
     ...
     * @param point a `GskPathPoint` on `path`
     * @returns The curvature of the path at the given point
     */
    point_get_curvature(point: PathPoint): [ /* returnType */ number, /* center */ Graphene.Point | null ]
    /**
     * Gets the position of the point.
     * @param point a `GskPathPoint` on `path`
     */
    point_get_position(point: PathPoint): /* position */ Graphene.Point
    /**
     ...
     */
    point_get_tangent(point: PathPoint, direction: PathDirection): /* tangent */ Graphene.Vec2
    /**
...
class Path {
     ...
     * @returns a new `GskPath`, or `NULL`   if @string could not be parsed
     */
    static parse(string: string | null): Path | null
}
