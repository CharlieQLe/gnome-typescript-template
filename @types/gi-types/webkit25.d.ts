...
export class MediaKeySystemPermissionRequest extends GObject.Object implements PermissionRequest {
    static $gtype: GObject.GType<MediaKeySystemPermissionRequest>;

    constructor(properties?: Partial<MediaKeySystemPermissionRequest.ConstructorProperties>, ...args: any[]);
    _init(properties?: Partial<MediaKeySystemPermissionRequest.ConstructorProperties>, ...args: any[]): void;
...
export class WebView extends WebViewBase implements Gtk.Accessible, Gtk.Buildable, Gtk.ConstraintTarget {
    ...
    run_javascript_from_gresource(resource: string, cancellable?: Gio.Cancellable | null): Promise<JavascriptResult>;
...
export class WebViewBase extends Gtk.Widget implements Gtk.Accessible, Gtk.Buildable, Gtk.ConstraintTarget {
