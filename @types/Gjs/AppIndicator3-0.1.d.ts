...
module Indicator {
     ...
     */
    interface ConnectionChangedSignalCallback {
     ...
     */
    interface NewAttentionIconSignalCallback {
        ($obj: Indicator): void
    }
     ...
     */
    interface NewIconSignalCallback {
        ($obj: Indicator): void
    }
     ...
     */
    interface NewIconThemePathSignalCallback {
     ...
     */
    interface NewLabelSignalCallback {
     ...
     */
    interface NewStatusSignalCallback {
    ...
    interface ScrollEventSignalCallback {
        ($obj: Indicator, arg1: number, arg2: any): void
    }
...
interface Indicator {
     ...
     */
    get_secondary_activate_target(): any
    /**
     ...
     */
    set_secondary_activate_target(menuitem: any | null): void
    /**
     * Wrapper function for property #AppIndicator:status.
    ...
    vfunc_scroll_event(delta: number, direction: any): void
    vfunc_unfallback(status_icon: any): void
    ...
    emit(sigName: "scroll-event", arg1: number, arg2: any, ...args: any[]): void
...
interface IndicatorClass {
    ...
    scroll_event: (indicator: Indicator, delta: number, direction: any) => void
    app_indicator_reserved_ats: () => void
    unfallback: (indicator: Indicator, status_icon: any) => void
