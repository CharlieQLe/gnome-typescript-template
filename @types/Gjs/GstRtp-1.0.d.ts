 ...
 */
function rtp_payload_info_for_name(media: string | null, encoding_name: string | null): RTPPayloadInfo
/**
...
module RTPBasePayload {
     ...
     */
    interface RequestExtensionSignalCallback {
        ($obj: RTPBasePayload, ext_id: number, ext_uri: string | null): RTPHeaderExtension
    }
...
class RTPPayloadInfo {
     ...
     * @returns a #GstRTPPayloadInfo or NULL when no info could be found.
     */
    static for_name(media: string | null, encoding_name: string | null): RTPPayloadInfo
    /**
     * Get the #GstRTPPayloadInfo for `payload_type`. This function is
     * mostly used to get the default clock-rate and bandwidth for static payload
     * types specified with `payload_type`.
