...
class DmaBufAllocator extends FdAllocator {
     ...
     * @constructor 
     * @returns a new dmabuf allocator, or NULL if the allocator    isn't available. Use gst_object_unref() to release the allocator after    usage
     */
    constructor() 
    /**
     * Return a new dmabuf allocator.
...
class FdAllocator extends Gst.Allocator {
     ...
     * @constructor 
     * @returns a new fd allocator, or NULL if the allocator    isn't available. Use gst_object_unref() to release the allocator after    usage
     */
    constructor() 
    /**
     * Return a new fd allocator.
