...
module Agent {
    ...
    interface ConstructorProperties extends GObject.Object.ConstructorProperties {
         ...
         */
        proxy_extra_headers?: GLib.HashTable | null
        /**
...
interface Agent {
    ...
    connect(sigName: "notify::proxy-extra-headers", callback: (($obj: Agent, pspec: GObject.ParamSpec) => void)): number
    connect_after(sigName: "notify::proxy-extra-headers", callback: (($obj: Agent, pspec: GObject.ParamSpec) => void)): number
    emit(sigName: "notify::proxy-extra-headers", ...args: any[]): void
...
class Address {
    ...
    // Constructors of Nice-0.1.Nice.Address
