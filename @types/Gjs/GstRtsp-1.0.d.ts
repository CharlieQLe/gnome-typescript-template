 ...
 * @returns #GST_RTSP_OK when @conn contains a valid connection.
 */
function rtsp_connection_create_from_socket(socket: Gio.Socket, ip: string | null, port: number, initial_buffer: string | null): [ /* returnType */ RTSPResult, /* conn */ RTSPConnection ]
/**
 ...
 * @returns #GST_RTSP_OK.
 */
function rtsp_transport_get_mime(trans: RTSPTransMode, mime: string | null): RTSPResult
/**
 ...
 * @returns a #GstRTSPResult.
 */
function rtsp_transport_parse(str: string | null, transport: RTSPTransport): RTSPResult
/**
 ...
 * @returns a #GstRTSPResult.
 */
function rtsp_url_parse(urlstr: string | null): [ /* returnType */ RTSPResult, /* url */ RTSPUrl ]
/**
...
class RTSPConnection {
     ...
     * @returns #GST_RTSP_OK when @conn contains a valid connection.
     */
    static create_from_socket(socket: Gio.Socket, ip: string | null, port: number, initial_buffer: string | null): [ /* returnType */ RTSPResult, /* conn */ RTSPConnection ]
}
...
class RTSPTransport {
     ...
     * @returns #GST_RTSP_OK.
     */
    static get_mime(trans: RTSPTransMode, mime: string | null): RTSPResult
    /**
     * Parse the RTSP transport string `str` into `transport`.
     * @param str a transport string
     * @param transport a #GstRTSPTransport
     * @returns a #GstRTSPResult.
     */
    static parse(str: string | null, transport: RTSPTransport): RTSPResult
}
...
class RTSPUrl {
     ...
     * @returns a #GstRTSPResult.
     */
    static parse(urlstr: string | null): [ /* returnType */ RTSPResult, /* url */ RTSPUrl ]
}
