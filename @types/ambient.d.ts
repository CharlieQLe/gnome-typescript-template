...
declare class TextDecoder {
    ...
    constructor(utfLabel: string = 'utf-8', options: Partial<{ fatal: boolean = false }>);

    decode(buffer: ArrayBuffer | DataView | Uint8Array, options: Partial<{ fatal: boolean = false }>): string;
}
