 ...
 */
function opcode_kind_from_string(str: string | null): OpcodeKind
/**
 * Converts the opcode kind to a string.
 * @param kind a #XbOpcodeKind, e.g. %XB_OPCODE_KIND_FUNCTION
 * @returns opcode kind, e.g. `FUNC`
 */
function opcode_kind_to_string(kind: OpcodeKind): string | null
/**
 ...
 */
function string_escape(str: string | null): string | null
...
interface MachineTextHandlerFunc {
    (self: Machine, opcodes: Stack, text: string | null, handled: boolean): boolean
}
...
interface Builder {
    ...
    // Own fields of Xmlb-2.0.Xmlb.Builder

    parent_instance: GObject.Object

    // Owm methods of Xmlb-2.0.Xmlb.Builder
    ...
    // Class property signals of Xmlb-2.0.Xmlb.Builder
...
class Builder extends GObject.Object {
    ...
    // Own properties of Xmlb-2.0.Xmlb.Builder

    static name: string
    static $gtype: GObject.GType<Builder>

    // Constructors of Xmlb-2.0.Xmlb.Builder
...
interface BuilderFixup {

    // Own fields of Xmlb-2.0.Xmlb.BuilderFixup

    parent_instance: GObject.Object

    // Owm methods of Xmlb-2.0.Xmlb.BuilderFixup
    ...
    // Class property signals of Xmlb-2.0.Xmlb.BuilderFixup
...
class BuilderFixup extends GObject.Object {
    ...
    // Own properties of Xmlb-2.0.Xmlb.BuilderFixup

    static name: string
    static $gtype: GObject.GType<BuilderFixup>

    // Constructors of Xmlb-2.0.Xmlb.BuilderFixup

    constructor(config?: BuilderFixup.ConstructorProperties) 
    /**
     ...
     */
    constructor(id: string | null, func: BuilderFixupFunc) 
    /**
     * Creates a function that will get run on every #XbBuilderNode compile creates.
     * @constructor 
     * @param id a text ID value, e.g. `AppStreamUpgrade`
     ...
     * @returns a new #XbBuilderFixup
     */
    static new(id: string | null, func: BuilderFixupFunc): BuilderFixup
    _init(config?: BuilderFixup.ConstructorProperties): void
}
...
interface BuilderNode {
    ...
    // Own fields of Xmlb-2.0.Xmlb.BuilderNode

    parent_instance: GObject.Object

    // Owm methods of Xmlb-2.0.Xmlb.BuilderNode
     ...
     */
    add_token(token: string | null): void
    /**
     ...
     */
    get_child(element: string | null, text: string | null): BuilderNode
    /**
     ...
     */
    set_element(element: string | null): void
    /**
    ...
    // Class property signals of Xmlb-2.0.Xmlb.BuilderNode
...
class BuilderNode extends GObject.Object {
    ...
    // Own properties of Xmlb-2.0.Xmlb.BuilderNode

    static name: string
    static $gtype: GObject.GType<BuilderNode>

    // Constructors of Xmlb-2.0.Xmlb.BuilderNode

    constructor(config?: BuilderNode.ConstructorProperties) 
    /**
     ...
     * @returns a new #XbBuilderNode
     */
    static new(element: string | null): BuilderNode
    _init(config?: BuilderNode.ConstructorProperties): void
}
...
interface BuilderSource {
    ...
    // Own fields of Xmlb-2.0.Xmlb.BuilderSource

    parent_instance: GObject.Object

    // Owm methods of Xmlb-2.0.Xmlb.BuilderSource
     ...
     * @returns %TRUE for success
     */
    load_xml(xml: string | null, flags: BuilderSourceFlags): boolean
    /**
    ...
    // Class property signals of Xmlb-2.0.Xmlb.BuilderSource
...
class BuilderSource extends GObject.Object {
    ...
    // Own properties of Xmlb-2.0.Xmlb.BuilderSource

    static name: string
    static $gtype: GObject.GType<BuilderSource>

    // Constructors of Xmlb-2.0.Xmlb.BuilderSource

    constructor(config?: BuilderSource.ConstructorProperties) 
    /**
    ...
    _init(config?: BuilderSource.ConstructorProperties): void
}
...
interface BuilderSourceCtx {

    // Own fields of Xmlb-2.0.Xmlb.BuilderSourceCtx

    parent_instance: GObject.Object

    // Owm methods of Xmlb-2.0.Xmlb.BuilderSourceCtx
    ...
    // Class property signals of Xmlb-2.0.Xmlb.BuilderSourceCtx
...
class BuilderSourceCtx extends GObject.Object {
    ...
    // Own properties of Xmlb-2.0.Xmlb.BuilderSourceCtx

    static name: string
    static $gtype: GObject.GType<BuilderSourceCtx>

    // Constructors of Xmlb-2.0.Xmlb.BuilderSourceCtx

    constructor(config?: BuilderSourceCtx.ConstructorProperties) 
    _init(config?: BuilderSourceCtx.ConstructorProperties): void
}
...
interface Machine {
    ...
    // Own fields of Xmlb-2.0.Xmlb.Machine

    parent_instance: GObject.Object

    // Owm methods of Xmlb-2.0.Xmlb.Machine
     ...
     */
    add_method(name: string | null, n_opcodes: number, method_cb: MachineMethodFunc): void
    /**
     ...
     */
    add_opcode_fixup(opcodes_sig: string | null, fixup_cb: MachineOpcodeFixupFunc): void
    /**
     ...
     * @param name function name, e.g. `contains`
     */
    add_operator(str: string | null, name: string | null): void
    /**
     ...
     */
    opcode_func_init(func_name: string | null): [ /* returnType */ boolean, /* opcode */ Opcode ]
    /**
     ...
     */
    parse(text: string | null, text_len: number): Stack
    /**
     * Parses an XPath predicate. Not all of XPath 1.0 or XPath 1.0 is supported,
     * and new functions and mnemonics can be added using xb_machine_add_method()
     * and xb_machine_add_text_handler().
     ...
     * @returns opcodes, or %NULL on error
     */
    parse_full(text: string | null, text_len: number, flags: MachineParseFlags): Stack
    /**
     ...
     */
    run(opcodes: Stack, exec_data: any | null): [ /* returnType */ boolean, /* result */ boolean ]
    /**
     ...
     * @returns a new #XbOpcode, or %NULL
     */
    run_with_bindings(opcodes: Stack, bindings: ValueBindings | null, exec_data: any | null): [ /* returnType */ boolean, /* result */ boolean ]
    /**
     ...
     */
    stack_pop(stack: Stack): [ /* returnType */ boolean, /* opcode_out */ Opcode ]
    /**
     ...
     */
    stack_push(stack: Stack): [ /* returnType */ boolean, /* opcode_out */ Opcode | null ]
    /**
     ...
     * @returns %TRUE on success, %FALSE otherwise
     */
    stack_push_text(stack: Stack, str: string | null): boolean
    /**
     ...
     * @returns %TRUE on success, %FALSE otherwise
     */
    stack_push_text_static(stack: Stack, str: string | null): boolean
    /**
     ...
     * @returns %TRUE on success, %FALSE otherwise
     */
    stack_push_text_steal(stack: Stack, str: string | null): boolean

    // Class property signals of Xmlb-2.0.Xmlb.Machine
...
class Machine extends GObject.Object {
    ...
    // Own properties of Xmlb-2.0.Xmlb.Machine

    static name: string
    static $gtype: GObject.GType<Machine>

    // Constructors of Xmlb-2.0.Xmlb.Machine

    constructor(config?: Machine.ConstructorProperties) 
    /**
     ...
     */
    static new(): Machine
    _init(config?: Machine.ConstructorProperties): void
}
...
interface Node {
    ...
    // Own fields of Xmlb-2.0.Xmlb.Node

    parent_instance: GObject.Object

    // Owm methods of Xmlb-2.0.Xmlb.Node
     ...
     */
    get_data(key: string | null): GLib.Bytes
     ...
     */
    query(xpath: string | null, limit: number): Node[]
    /**
     ...
     */
    query_attr(xpath: string | null, name: string | null): string | null
    /**
     * Searches the node using an XPath query, returning up to one result.
     * 
     * It is safe to call this function from a different thread to the one that
     ...
     * @returns a #guint64, or %G_MAXUINT64 if unfound
     */
    query_attr_as_uint(xpath: string | null, name: string | null): number
    /**
     ...
     * @returns a string, or %NULL if unfound
     */
    query_export(xpath: string | null): string | null
    /**
     * Searches the node using an XPath query, returning up to one result.
     * 
     ...
     */
    query_first(xpath: string | null): Node
    /**
     ...
     * @returns a string, or %NULL if unfound
     */
    query_text(xpath: string | null): string | null
    /**
     * Searches the node using an XPath query, returning up to one result.
     * 
     * It is safe to call this function from a different thread to the one that
     ...
     * @returns a #guint64, or %G_MAXUINT64 if unfound
     */
    query_text_as_uint(xpath: string | null): number
    /**
     ...
     * @param data a #GBytes
     */
    set_data(key: string | null, data: GLib.Bytes): void
    ...
    // Class property signals of Xmlb-2.0.Xmlb.Node
...
class Node extends GObject.Object {
    ...
    // Own properties of Xmlb-2.0.Xmlb.Node

    static name: string
    static $gtype: GObject.GType<Node>

    // Constructors of Xmlb-2.0.Xmlb.Node
...
interface Query {
    ...
    // Own fields of Xmlb-2.0.Xmlb.Query

    parent_instance: GObject.Object

    // Owm methods of Xmlb-2.0.Xmlb.Query
     ...
     */
    bind_str(idx: number, str: string | null): boolean
    /**
     * Assigns a string to a bound value specified using `?`.
     * @param idx an integer index
    ...
    // Class property signals of Xmlb-2.0.Xmlb.Query
...
class Query extends GObject.Object {
    ...
    // Own properties of Xmlb-2.0.Xmlb.Query

    static name: string
    static $gtype: GObject.GType<Query>

    // Constructors of Xmlb-2.0.Xmlb.Query
     ...
     * @returns a #XbQuery
     */
    constructor(silo: Silo, xpath: string | null) 
    /**
     * Creates a query to be used by `silo`. It may be quicker to create a query
     * manually and re-use it multiple times.
     * @constructor 
     ...
     * @returns a #XbQuery
     */
    static new(silo: Silo, xpath: string | null): Query
    /**
     * Creates a query to be used by `silo`. It may be quicker to create a query
     * manually and re-use it multiple times.
     * 
     ...
     * @returns a #XbQuery
     */
    static new_full(silo: Silo, xpath: string | null, flags: QueryFlags): Query
...
module Silo {
    ...
    interface ConstructorProperties extends GObject.Object.ConstructorProperties {
        ...
        // Own constructor properties of Xmlb-2.0.Xmlb.Silo
         ...
         */
        enable_node_cache?: boolean | null
        guid?: string | null
    }
...
interface Silo {
    ...
    // Own properties of Xmlb-2.0.Xmlb.Silo
    ...
    // Own fields of Xmlb-2.0.Xmlb.Silo

    parent_instance: GObject.Object

    // Owm methods of Xmlb-2.0.Xmlb.Silo
     ...
     */
    get_profile_string(): string | null
    /**
     ...
     */
    lookup_query(xpath: string | null): Query
    /**
     * Searches the silo using an XPath query, returning up to `limit` results.
     * 
     * It is safe to call this function from a different thread to the one that
     ...
     * @returns %TRUE for success
     */
    query_build_index(xpath: string | null, attr: string | null): boolean
    /**
    ...
    // Class property signals of Xmlb-2.0.Xmlb.Silo
    ...
    emit(sigName: "notify::enable-node-cache", ...args: any[]): void
...
class Silo extends GObject.Object {
    ...
    // Constructors of Xmlb-2.0.Xmlb.Silo

    constructor(config?: Silo.ConstructorProperties) 
    /**
     * Creates a new silo.
     * @constructor 
     ...
     */
    static new_from_xml(xml: string | null): Silo
    _init(config?: Silo.ConstructorProperties): void
}

interface BuilderClass {

    // Own fields of Xmlb-2.0.Xmlb.BuilderClass
...
abstract class BuilderClass {
    ...
    // Own properties of Xmlb-2.0.Xmlb.BuilderClass

    static name: string
}

interface BuilderFixupClass {

    // Own fields of Xmlb-2.0.Xmlb.BuilderFixupClass

    parent_class: GObject.ObjectClass
}

abstract class BuilderFixupClass {

    // Own properties of Xmlb-2.0.Xmlb.BuilderFixupClass

    static name: string
}

interface BuilderNodeClass {

    // Own fields of Xmlb-2.0.Xmlb.BuilderNodeClass

    parent_class: GObject.ObjectClass
}

abstract class BuilderNodeClass {

    // Own properties of Xmlb-2.0.Xmlb.BuilderNodeClass

    static name: string
}

interface BuilderSourceClass {

    // Own fields of Xmlb-2.0.Xmlb.BuilderSourceClass

    parent_class: GObject.ObjectClass
}

abstract class BuilderSourceClass {

    // Own properties of Xmlb-2.0.Xmlb.BuilderSourceClass

    static name: string
}

interface BuilderSourceCtxClass {

    // Own fields of Xmlb-2.0.Xmlb.BuilderSourceCtxClass

    parent_class: GObject.ObjectClass
}

abstract class BuilderSourceCtxClass {

    // Own properties of Xmlb-2.0.Xmlb.BuilderSourceCtxClass
...
interface MachineClass {
    ...
    // Own fields of Xmlb-2.0.Xmlb.MachineClass

    parent_class: GObject.ObjectClass
}

abstract class MachineClass {

    // Own properties of Xmlb-2.0.Xmlb.MachineClass
...
interface NodeAttrIter {
    ...
    // Owm methods of Xmlb-2.0.Xmlb.NodeAttrIter
...
class NodeAttrIter {
    ...
    // Own properties of Xmlb-2.0.Xmlb.NodeAttrIter
...
interface NodeChildIter {
    ...
    // Owm methods of Xmlb-2.0.Xmlb.NodeChildIter
     ...
     */
    next(): [ /* returnType */ boolean, /* child */ Node ]
}
...
class NodeChildIter {
    ...
    // Own properties of Xmlb-2.0.Xmlb.NodeChildIter
...
interface NodeClass {
    ...
    // Own fields of Xmlb-2.0.Xmlb.NodeClass
...
abstract class NodeClass {
    ...
    // Own properties of Xmlb-2.0.Xmlb.NodeClass
...
interface Opcode {
    ...
    // Owm methods of Xmlb-2.0.Xmlb.Opcode
     ...
     * @param str a string
     */
    text_init(str: string | null): void
    /**
     ...
     * @param str a string
     */
    text_init_static(str: string | null): void
    /**
     ...
     * @param str a string
     */
    text_init_steal(str: string | null): void
    /**
...
class Opcode {
    ...
    // Own properties of Xmlb-2.0.Xmlb.Opcode

    static name: string

    // Constructors of Xmlb-2.0.Xmlb.Opcode
     ...
     * @returns a #XbOpcodeKind, e.g. %XB_OPCODE_KIND_TEXT
     */
    static kind_from_string(str: string | null): OpcodeKind
    /**
     * Converts the opcode kind to a string.
     * @param kind a #XbOpcodeKind, e.g. %XB_OPCODE_KIND_FUNCTION
     * @returns opcode kind, e.g. `FUNC`
     */
    static kind_to_string(kind: OpcodeKind): string | null
}

interface QueryClass {

    // Own fields of Xmlb-2.0.Xmlb.QueryClass
...
abstract class QueryClass {
    ...
    // Own properties of Xmlb-2.0.Xmlb.QueryClass
...
interface QueryContext {
    ...
    // Owm methods of Xmlb-2.0.Xmlb.QueryContext
...
class QueryContext {
    ...
    // Own properties of Xmlb-2.0.Xmlb.QueryContext
...
interface SiloClass {
    ...
    // Own fields of Xmlb-2.0.Xmlb.SiloClass

    parent_class: GObject.ObjectClass
}

abstract class SiloClass {

    // Own properties of Xmlb-2.0.Xmlb.SiloClass
...
interface Stack {
    ...
    // Owm methods of Xmlb-2.0.Xmlb.Stack

    /**
     * Pops an opcode off the stack.
     * @returns %TRUE if popping succeeded, %FALSE if the stack was empty already
     */
    pop(): [ /* returnType */ boolean, /* opcode_out */ Opcode ]
    /**
     * Pushes a new empty opcode onto the end of the stack. A pointer to the opcode
     ...
     * @returns %TRUE if a new empty opcode was returned, or %FALSE if the stack has    reached its maximum size
     */
    push(): [ /* returnType */ boolean, /* opcode_out */ Opcode | null ]
    /**
...
class Stack {
    ...
    // Own properties of Xmlb-2.0.Xmlb.Stack
...
interface ValueBindings {
    ...
    // Owm methods of Xmlb-2.0.Xmlb.ValueBindings
     ...
     */
    bind_str(idx: number, str: string | null, destroy_func: GLib.DestroyNotify | null): void
    /**
     ...
     * @returns %TRUE if @idx was bound, %FALSE otherwise
     */
    lookup_opcode(idx: number): [ /* returnType */ boolean, /* opcode_out */ Opcode ]
}
...
class ValueBindings {
    ...
    // Own properties of Xmlb-2.0.Xmlb.ValueBindings
